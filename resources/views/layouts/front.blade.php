        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-md-3">
                    ...
                    <p class="text-white mb-3">Professional cleaning services you can trust. We make your space spotless.</p>
                ...
                <div class="col-md-3">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{{route('front.index')}}" class="text-white text-decoration-none">Home</a></li>
                        <li><a href="{{route('front.services')}}" class="text-white text-decoration-none">Services</a></li>
                        <li><a href="{{route('front.about')}}" class="text-white text-decoration-none">About</a></li>
                        <li><a href="{{route('front.gallery')}}" class="text-white text-decoration-none">Gallery</a></li>
                        <li><a href="{{route('front.contact')}}" class="text-white text-decoration-none">Contact</a></li>
                    </ul>
                </div>
            ...
            <div class="text-center text-white">
                <p>&copy; {{date('Y')}} Delvora. All rights reserved.</p>
            </div>
        </div>
    </footer>
